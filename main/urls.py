...
urlpatterns = [
    ...
    path('view_writer_profile/<int:pk>',login_required(views.ViewWriterProfile.as_view()),name = 'view_writer_profile'),
    path('view_producer_profile/<int:pk>',login_required(views.ViewProducerProfile.as_view()),name = 'view_producer_profile'),
